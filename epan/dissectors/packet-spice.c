...
dissect_buttons_state(tvbuff_t *tvb, proto_tree *tree, uint32_t offset)
{
    ...
    proto_tree_add_item(subtree, hf_button_mask_left, tvb, offset, 2, ENC_LITTLE_ENDIAN);
    proto_tree_add_item(subtree, hf_button_mask_middle, tvb, offset, 2, ENC_LITTLE_ENDIAN);
    proto_tree_add_item(subtree, hf_button_mask_right, tvb, offset, 2, ENC_LITTLE_ENDIAN);
    return 2;
}
...
proto_register_spice(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_buttons_state,
          { "Mouse buttons mask", "spice.buttons_state",
            FT_UINT16, BASE_HEX, NULL, 0x0,
            NULL, HFILL }
        },
        { &hf_button_mask_left,
